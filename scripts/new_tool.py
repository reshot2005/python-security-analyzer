...
Substitutes python-security-analyzer, Python Security Analyzer, and __ORG_NAME__ placeholders.
...
REPLACEMENTS_TEMPLATE = [
    ("python_security_analyzer", "{slug_underscore}"),
    ("python-security-analyzer", "{slug_kebab}"),
    ("Python Security Analyzer", "{name}"),
    ("python-security-analyzer", "{slug_kebab}"),
    ("Python Security Analyzer", "{name}"),
    ("__ORG_NAME__", "{org}"),
]
